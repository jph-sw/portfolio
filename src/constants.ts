import UhuruIcon from "./assets/uhuru.svg";
import type { Project, SocialLink } from "./types.ts";
...
export const PROJECTS: Project[] = [
	...
	},
	{
		...
		techStack: ["Tanstack Start", "React", "Bun"],
		imageUrl: UhuruIcon.src,
		year: "2026",
		link: "https://github.com/jph-sw/uhuru",
	},
];
